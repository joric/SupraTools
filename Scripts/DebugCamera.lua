...
-- https://github.com/UE4SS-RE/RE-UE4SS/pull/1050 is about to introduce a breaking change
-- so now it uses getPlayerController(), getDebugCameraController() from main.lua
